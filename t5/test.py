...
def main(args):
    ...
    # test
    test_result = test(model=model,tokenizer=tokenizer, device=args.device, data_loader=test_loader, label_id_list=labels_id_list)
    print(test_result)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weights_name', type=str, default='mt5model-Feb16_11-59-53-epoch4.pth')
