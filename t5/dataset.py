...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # text = self.data[index]["text"]+' '+'目标:'+self.data[index]["target"]+' '+self.data[index]["全部立场标签"]
        # # text = self.data[index]["text"]+' '+'目标:'+self.data[index]["target"]+' '+'背景:'+self.data[index]["简约背景"]
        # text = self.data[index]["text"]+' '+'目标:'+self.data[index]["target"]+' '+'背景:'+self.data[index]["全部背景"]
        # # text = self.data[index]["text"]+' '+'目标:'+self.data[index]["target"]+' '+'背景:'+self.data[index]["简约背景"]+' '+self.data[index]["全部立场标签"]
        # text = self.data[index]["text"]+' '+'目标:'+self.data[index]["target"]+' '+'背景:'+self.data[index]["全部背景"]+' '+self.data[index]["全部立场标签"]
        # label = self.data[index]["label"]
